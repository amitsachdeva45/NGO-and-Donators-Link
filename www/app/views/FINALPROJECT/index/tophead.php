...
#input1:hover{width:48%; height:100%; color:#006;  background-color:#999; font-weight:bold; text-shadow:#000; margin-left:2px; cursor:pointer;}
...
<body>
 <div id="heading">
	...
	<ul>
        ...
        <ul>
			<li class="subfirst"><a href="index/moneyhome.php">MONEY</a></li>
            <li class="subfirst"><a href="index/articlehome.php" >ARTICLE</a></li>
		</ul>
        </li>
       
		<li><a href="index/signupmainpage.php">AS A NGO</a></li>
