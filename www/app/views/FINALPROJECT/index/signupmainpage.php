...
<form action="" enctype="multipart/form-data" method="get" id="formsign">
<!--FORMSIGN1-->
<div id="formsign1"  >
...
<tr><td><textarea placeholder="OBJECTIVE OF YOUR NGO"  style="margin-left:56%; margin-top:20px; border:2px solid black; resize:vertical;" name="obj" cols="40" rows="7"  required/></textarea>
...
<tr><td><textarea placeholder="MAIN OBJECTIVE OF EVENT"  style="margin-left:55%; margin-top:20px; border:2px solid black; resize:vertical;" name="obj1" cols="50" rows="7"  required/></textarea>
...
<tr><td><textarea placeholder="MAIN OBJECTIVE OF EVENT"  style="margin-left:55%; margin-top:20px; border:2px solid black; resize:vertical;" name="obj2" cols="50" rows="7"  required/></textarea>
...
<tr><td><textarea placeholder="MAIN OBJECTIVE OF EVENT"  style="margin-left:55%; margin-top:20px; border:2px solid black; resize:vertical;" name="obj3" cols="50" rows="7"  required/></textarea>
...
<tr><td><input type="button" value="SUBMIT" onClick="finally1();" style="width:100px; height:40px; color:white; background-color:black; float:right;">
