...
function checkfulldetails()
{
	...
	{
		alert('Enter Correctly Pin Code eg:xxxxxx');return false;
	}
	else if(rf==false)
	{
		alert('Enter Correctly Mobile Number eg:xxxxxxxxxx');return false;
	}
...
#head1,#head2,#head3{width:32%; min-width: 100px; height:100%; margin-left:3px; border:1px solid black; background-color:black; float:left;}
...
#city,#pin,#state,#pswd,#conpswd,#mobile,#mobile1,#member1,#member2,#mobile2,#member3,#mobile3,#poe1,#poe2,#date1,#date2,#date3,#poe3{width:300px;
min-width: 100px; height:30px; border:2px solid black; margin-left:10%;  margin-top:20px;}
#form111{width:800px; height:500px auto; float:left; margin-left:17%; border:1px solid black; margin-top:30px;}
#address{margin-left:56%; margin-top:20px; border:2px solid black; resize:vertical;}
#next111{width:100px; height:40px; margin-left:10px; color:white; background-color:black; float:right;}
.lbl111{margin-left:49%; margin-top:10px; color:white;}
.moe{margin-left:55%; margin-top:20px; border:2px solid black; resize:vertical;}
#sbm{width:100px; height:40px; color:white; background-color:black; float:right;}
.tble111{width:100%; height:100%;}
</style>
</head>

<body>
<a href="/"><input type="button" value="HOME" style="position:absolute; top:100px; left:0px; width:100px; height:40px; background-color:black; border:1px solid white; color:white;"></a>
...
<div  id="form111">
<form  action="/ngosign"  method='post' id="formsign" >
<!--FORMSIGN1-->
...
<tr><td><textarea placeholder="ADDRESS" class="input2"  name="address" id="address" cols="40" rows="7"  required/></textarea>

<tr><td><input type="text" placeholder="CITY" name="city" id="city" required/><td><input type="text" placeholder="PIN" pattern="[0-9]{6}" name="pin" id="pin" title="enter erigjt" required/>
...
<tr><td><input type="button" value="NEXT   >>" onClick="showmemberdetails();"  id="next111">
...
<tr><td ><input type="text" placeholder="NAME OF SECRETARY" name="secret5" id="aa1" />
<tr><td ><input type="text" placeholder="YOUR WEBSITE" name="website" id="aa1" />
<tr><td><label style="margin-left:50%; margin-top:10px; color:white;">DATE OF ESTABLISHMENT</label>
<tr><td ><input type="date"  name="date5" id="aa1" />
...
<tr><td><textarea placeholder="OBJECTIVE OF YOUR NGO"  style="margin-left:56%; margin-top:20px; border:2px solid black; resize:vertical;"
name="obj5" cols="40" rows="7"  ></textarea>
...
<tr><td><label class="lbl111" > EVENT 1</label>
<tr><td><input type="date"   id="date1" name="date1" /><td><input type="text" placeholder="PLACE OF EVENT"   id="poe1" name="poe1" />
<tr><td><textarea placeholder="MAIN OBJECTIVE OF EVENT" class="moe"  name="obj1" cols="50" rows="7" /></textarea>
<tr><td><label class="lbl111" > EVENT 2</label>
<tr><td><input type="date"   id="date2" name="date2" /><td><input type="text" placeholder="PLACE OF EVENT"   id="poe2" name="poe2" />
<tr><td><textarea placeholder="MAIN OBJECTIVE OF EVENT" class="moe"   name="obj2" cols="50" rows="7"  /></textarea>
<tr><td><label class="lbl111" > EVENT 3</label>
<tr><td><input type="date"   id="date3" name="date3" /><td><input type="text" placeholder="PLACE OF EVENT"   id="poe3" name="poe3" />
<tr><td><textarea placeholder="MAIN OBJECTIVE OF EVENT"  class="moe"  name="obj3" cols="50" rows="7"  /></textarea>

<tr><td><input type='submit' value="SUBMIT" id="sbm"  ></form>
